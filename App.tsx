...
const App: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-screen bg-brand-dark text-slate-50 overflow-hidden flex flex-col">
      ...
      {/* Main Content Area */}
      <main className="flex-1 relative w-full h-full z-10 p-4 md:p-12 flex flex-col">
      ...
      {/* Controls UI */}
      <div className="relative z-20 p-6 flex justify-between items-center bg-gradient-to-t from-slate-950/80 to-transparent">
        ...
        <div className="flex items-center space-x-6">
            <button 
                ...
                className="p-3 rounded-full bg-slate-800/50 hover:bg-slate-700 hover:text-brand-accent transition-all disabled:opacity-30 disabled:cursor-not-allowed backdrop-blur-sm"
            >
                <ChevronLeft size={24} />
            </button>
            ...
            <button 
                ...
                className="p-3 rounded-full hover:bg-slate-800/50 transition-colors hidden md:block"
